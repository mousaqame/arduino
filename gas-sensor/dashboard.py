#!/usr/bin/env python3
"""Live dashboard for the gas_serial Arduino firmware.
...
avrdude and taking it back afterwards.
    ...
    python dashboard.py                 # COM8, http://127.0.0.1:8789
    python dashboard.py --port COM3 --http-port 9002 --no-open --lan
"""
...
SKETCH_INFO = {
    "gas_serial": {
        ...
        "blurb": "The full version. Warms up, learns clean air, and talks to this website.",
        "needed": True,
    },
    "gas_original": {
        "title": "Simple version",
        "blurb": "Your original sketch. Beeps past a fixed number, but this website can't read it.",
        "needed": False,
    },
}
...
def main() -> None:
    ...
    print(f"gas dashboard: {url}   (serial {args.port} @ {args.baud})")
    if args.lan:
